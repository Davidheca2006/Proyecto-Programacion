...
public class Supermercado {
    ...
    public static void productosSuper(){
        ...
        double[] precios = {1.5, 0.9, 1.2, 3.5, 2.0, 1.8, 5.0, 2.5, 1.1, 0.8, 3.0, 1.6, 4.5, 2.8, 1.0, 2.2, 1.7, 2.9, 0.5, 1.9};
    ...
    //llena el almacen del super con 10 objetos al azar
    public static void ListaMama(){
        Random rng = new Random();
        for (int i=0; i<yourProducts.length; i++){
            int random = rng.nextInt(0,20);
            Producto unit = products[random];
